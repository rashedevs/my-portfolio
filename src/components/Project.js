        ...
        <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
          <div className="pb-8 flex flex-col justify-center items-center">
            ...
            <p className="py-4 font-semibold">
              <span className="text-pink-600">`// </span> CHECK OUT SOME COOL
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
            <div>
              ...
              <h3 className="text-center text-lg font-bold pt-2">Metalik</h3>
            </div>
            <div>
              <div
              ...
              >
                ...
                <div className="opacity-0 group-hover:opacity-100">
                  ...
                  <div className="pt-8 text-center">
                    <a
                      target={`_blank`}
                      href="https://carventory-581a5.web.app/"
                    >
                      <button className="text-center rounded-lg px-4 py-2 m-2 bg-white text-gray-700 font-bold text-lg hover:bg-pink-600 hover:text-white">
                        Live
                      </button>
              ...
              <h3 className="text-center text-lg font-bold pt-2">Carventory</h3>
            </div>
            <div>
              <div
              ...
              <h3 className="text-center text-lg font-bold pt-2">
                Momenta Photography
              </h3>
            </div>
            <div>
              ...
              <h3 className="text-center text-lg font-bold pt-2">Clock Zone</h3>
            </div>
            <div>
              <div
              ...
              <h3 className="text-center text-lg font-bold pt-2">Bear World</h3>
            </div>
            <div>
              <div
